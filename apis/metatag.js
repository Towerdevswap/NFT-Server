  ...
  if (account) {
    return res.json({
      ...
      data: {
        ...
        image: account.imageHash? 'blush-rare-tiglon-705.mypinata.cloud/ipfs/'+account.imageHash : 'https://openzoo.io/icon.png',
      },
    });
  } else {
...
router.get('/collection/:address', async (req, res) => {
  ...
  return res.json({
    ...
    data: {
      ...
      image: 'blush-rare-tiglon-705.mypinata.cloud/ipfs/'+collection.logoImageHash,
    },
  });
